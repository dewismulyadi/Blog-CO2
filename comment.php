					...
					<form class="p-4 m-4 bg-white form-horizontal rounded-alt" action="<?php the_permalink(); ?>" method="post">
                        ...
                        <div class="p-4 m-4">
                            ...
                            <div class="px-4 py-3 form-group row">
                                ...
                                <div class="col-md-9 col-sm-12">
                                    <textarea type="comment" name="message_text" placeholder="Input your comment" class="border-0 form-control form-text border-bottom w-100" rows="5"><?php echo $message; ?></textarea>
									</div>
