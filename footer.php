	...
	<footer class="bg-dark">
        <div class="container">
            <div class="pt-5 pb-5">
                <div class="row">
                    <div class="col-lg-3 col-md-3">
                        <img src="image/logo.png" width="192px" height="64px">
                        <p class="mt-4 text-yellow font-weight-bold">Monday - Friday : 9 AM - 7 PM (GMT+8)</p>
                    </div>
                    <div class="col-lg-7 col-md-2 table-responsive">
                        <table id="table-footer">
                    ...
                    <!--<div class="col-lg-2 col-md-2">-->
                    <!--    <h5 class="mb-2 text-uppercase text-yellow font-weight-bold">contact us</h5>-->
                    ...
                    <!--    <p class="mb-0 text-yellow"><i class="fas fa-phone-alt"></i>  <span class="text-white">&nbsp; &nbsp;  +65 8430 0677</span></p>-->
                    <!--</div>-->
                    <!--<div class="col-lg-2 col-md-2">-->
                    <!--    <h5 class="mb-2 text-uppercase text-dark font-weight-bold">contact us</h5>-->
                    ...
                    <!--    <p class="mb-0 text-yellow"><i class="fas fa-phone-alt"></i>  <span class="text-white">&nbsp; &nbsp;+62 822-4223-3230</span></p>-->
                    <!--</div>-->
                    <!--<div class="col-lg-2 col-md-2">-->
                    <!--    <h5 class="mb-2 text-uppercase text-dark font-weight-bold">contact us</h5>-->
                    <!--    <p class="text-yellow font-weight-bold"><i class="fas fa-map-marker-alt"></i>&nbsp; &nbsp;Indonesia Office</p>-->
...
>>>>>>> eb54809db3888be78e5513ba47cc502ae3c47b89
</html>